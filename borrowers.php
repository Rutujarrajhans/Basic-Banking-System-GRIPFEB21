...
<div class="container-fluid">
	<div class="col-lg-12">
      ...
      font-size: 30px;"class="btn btn-dark btn-lg download-button" type="button" data-id="<?php echo $row['id'] ?>"><i class="fa fa-edit"></i>EDIT</button>
						 			<button style="border-radius: .10rem;
      background-color: #5a6f83;
      border-width: 5px;
      border-color: black;
      font-size: 30px;width:132px;height:50px;" class="btn btn-outline-danger btn-sm delete_borrower" type="button" data-id="<?php echo $row['id'] ?>"><i class="fa fa-trash"></i>DELETE</button>
						 	</td>
