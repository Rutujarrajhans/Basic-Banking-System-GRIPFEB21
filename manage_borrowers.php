...
.cont{
  ...
  @media screen and (max-width: 500px) {
    .name,.firstname,.firstlabel,.radio-one,.lastlabel,.company,.email,.code,.number,.area-code,.phone-number,.option,.option option,
    .radio,.radio input,.button,.sart,.end,.bid ,.cont,.file,.input[type=submit] {
      width: 100%;
      margin-top: 0;
      height: auto;
...
?>
			...
			<div class="reg" style="text-align:center;margin-left:380px;"><h1>Borrower Registration</h1></div>
    <div class="main"style="margin-left:380px;">
        <form action="index.php" method="POST">
            <div id="name">
                ...
                <h2 class="name">Tax_id</h2>
                <input class="company" type="text" name="model"><br>
               
			<a href="home.html"><button type="button" style="border-radius: .10rem;margin-left:300px;
      background-color: #5a6f83;
      border-width: 5px;
      border-color: black;
      font-size: 30px;"class="btn btn-dark btn-lg download-button"></i>SUBMIT</button></a>
		</form>
	</div>
</div>
